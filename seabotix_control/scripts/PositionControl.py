...
class PositionControllerNode:
    ...
    def odometry_callback(self, msg):
        ...
        # Modification here to original PositionControl.py in uuv_control_cascaded_pids
        ...
        e_rot[0] = 0.0 # set roll error to 0.0
        e_rot[1] = 0.0 # set pitch error to 0.0
    ...
    def config_callback(self, config, level):
        ...
        # rospy.logwarn("Position Control PID: p={}, i={}, d={}, sat={}".format(config['pos_p'], config['pos_i'], config['pos_d'], config['pos_sat']))
